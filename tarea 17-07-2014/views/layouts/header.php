<?php 
  define('BASEURL','http://localhost/prograweb/tarea 17-07-2014');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <nav class="navbar navbar-default" role="navigation">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="ejemplo" href="tipo.html"><span class="glyphicon glyphicon-ok-sign"></span>Tipo Integrante</a> 
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    // navar para login y para loguot
                    <?php if(!isset($_SESSION['user']) ){ ?>

                    
                    <li><a href=" echo BASEURL; ?>/views/site/login.php"><span class="glyphicon-log-in"></span>login</a></li>
                    <?php } else { ?>
                   
                    <li><a href=" echo BASEURL; ?>/views/site/logout.php"><span class="glyphicon-log-in"></span>login</a></li>
                    <?php }  ?>
